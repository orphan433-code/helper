...
from core.config import bank_settings, capture_region, ocr_settings
from device.input_device import tap_at, tap_point
from device.ocr import find_text, run_ocr
...
def tap_after_ocr(
    ...
    *,
    ...
    from bank.human import click_pause
...
def paste_text(
    ...
    *,
    ...
    _ = verbose
    from device.input_adb import paste_text as adb_paste
...
def input_field_text(
    ...
    *,
    ...
    if method_l in ("softkey", "ui", "tapkey", "amount"):
        from device.softkey import type_amount_smart
