...
from bank_screen import find_label, find_labels, scan_screen
from clicker import tap_after_ocr
from config_loader import bank_settings, capture_region_or_raise
from input_device import scroll_carousel_horizontal
...
def tap_nav_target(
    ...
    *,
    ...
    from input_device import focus_iphone_mirror, tap_sequence
