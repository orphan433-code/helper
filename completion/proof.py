...
from bank.receipt import is_success_receipt, parse_receipt_image
from bank.screen import scan_screen
from completion.registry import attach_proof, proofs_dir, videos_dir
from core.config import capture_region_or_raise, completion_settings
from core.deal_bridge import PENDING_DEAL_PATH
...
def _sync_from_phone(*, kind: str, since_ts: float) -> None:
    ...
    try:
        from device.phone_media import pull_new_phone_media
