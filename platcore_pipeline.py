...
from logkit import debug, error, info, is_verbose, ok, section, warn
from models import TzkDeal
from platcore_accept import accept_deal_in_same_tab
...
from browser_session import close_stale_tabs
from deal_bridge import deal_to_transfer_form, save_pending_deal
...
async def run_bank_for_deal(
    ...
    *,
    ...
    from bank_flow import run_bank_flow
    from config_loader import bank_settings
    from platcore_card import refresh_deal_eur_from_platcore_page
