...
from bank_form import BankFormError, BankPostPaymentError
from bank_screen import find_labels, scan_screen
from config_loader import bank_settings, capture_region_or_raise, completion_settings
from clicker import tap_after_ocr
from ocr import OcrHit, run_ocr
from screenshot import get_retina_scale, take_screenshot
...
def read_review_credit_eur(hits: list[OcrHit]) -> float | None:
    ...
    from bank_form import _parse_eur_value
...
def run_stage3c_confirm_review(
    *,
    ...
    """
    from bank_form import _reconcile_eur_ocr
    from sms_notify_watch import snapshot_notification_keys
...
def run_stage4_sms_notification(
    *,
    ...
    """
    from softkey import type_code_smart
    from sms_notify_watch import snapshot_notification_keys, wait_for_sms_code
...
def run_stage5_return_home(
    *,
    ...
    if comp.get("save_proofs_on_success"):
        try:
            from proof_capture import save_success_proof_before_home
