...
from bank.form import TransferFormData
from core.models import TzkDeal
from core.paths import RUNTIME_DIR
from core.validators import PanicError, sanitize_holder_name_for_bank

PENDING_DEAL_PATH = RUNTIME_DIR / "pending_deal.json"
