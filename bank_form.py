...
from bank_nav import wait_for_label
from bank_pin import PinUnlockError
from bank_screen import find_labels, scan_screen
from clicker import input_field_text, tap_after_ocr
from config_loader import bank_settings, capture_region_or_raise
from input_device import dismiss_keyboard, ime_done, ime_next, tap_keyboard_globe
...
def _confirm_transfer(
    ...
    *,
    ...
    """
    from bank_confirm import _confirm_cfg
    ...
    if android_continue:
        ...
        from input_adb import quick_scroll_form_down
...
def _type_value_only(
    ...
    *,
    ...
    if gap > 0:
        from bank_human import sleep_jitter
...
def run_stage3_transfer_form(
    ...
    *,
    ...
    if ime_chain:
        ...
        done_tapped = False
        if used_keypad:
            from softkey import tap_soft_done
    ...
    if confirmed:
        from bank_confirm import run_post_transfer_steps
